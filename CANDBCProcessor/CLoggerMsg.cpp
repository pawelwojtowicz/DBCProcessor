...
uint8_t CLoggerMsg::sDebugZoneMask = 0xFF;
...
CLoggerMsg::CLoggerMsg(const uint8_t debugZone, const char* srcFileName, const uint32_t srcLineNo )
...
void CLoggerMsg::SetDebugZone( const uint8_t dzMask)
{
